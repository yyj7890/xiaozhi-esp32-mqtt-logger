...
这是个人维护的固件仓库，不是小智官方发布渠道。代码基于上游项目
[78/xiaozhi-esp32](https://github.com/78/xiaozhi-esp32)，并保留其 MIT 许可证与版权声明。

- 本仓库只包含固件，不包含后端服务端代码。
- 本地服务端部署记录见 [docs/LOCAL_SERVER.md](docs/LOCAL_SERVER.md)。其中的密钥和配置文件不得提交到本仓库。
