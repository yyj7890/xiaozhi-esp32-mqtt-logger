...
public:
    ...
    // When local logging is enabled it becomes an explicit startup gate.  This
    // waits only from the activation worker; audio/UI/Wi-Fi callbacks remain
    // non-blocking.  Disabled logging always returns true.
