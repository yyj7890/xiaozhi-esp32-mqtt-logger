...
public:
    ...
    bool PushPacketToDecodeQueue(std::unique_ptr<AudioStreamPacket> packet, bool wait = false, std::function<void(bool)> on_output_complete = {});
...
private:
    ...
    std::deque<std::function<void(bool)>> audio_decode_completion_queue_;
